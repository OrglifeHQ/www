  ...
  return (
    <section className="mx-auto flex flex-col items-center gap-8 bg-black py-16 md:py-24">
      ...
      <div className="w-full px-4 md:max-w-7/8 md:px-0">
        <h2 className="text-left text-2xl font-['Clash_Display'] font-semibold uppercase md:text-[2rem]">
          TESTIMONIALS
        </h2>
      </div>

      {/* Content */}
      <div className="no-scrollbar flex w-full gap-4 overflow-auto px-[3.125%] md:gap-8 md:px-[6.25%]">
        {testimonials.map((testimonial) => (
          <div
            key={testimonial.id}
            className="group relative flex min-w-7/8 flex-col gap-8 border border-white/25 p-6 md:min-w-1/4"
          >
