...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gradient-to-b from-white/10 to-purple-900 max-md:px-4 py-24 text-white flex flex-col items-center">
      <div className="flex flex-col items-start justify-between gap-12 lg:flex-row w-full h-full md:max-w-7/8">
        {/* Left section */}
        <div className="flex w-full flex-col justify-between gap-8">
          <div className="flex flex-col gap-4">
            <Link href="/" className="font-[Clash_Display] text-2xl font-bold">
              ORGLIFE
            </Link>
        ...
        <div className="flex w-full flex-col gap-4 text-right text-base md:max-w-2/5">
          {[
            ...
            <Link
              key={index}
              href={page.path}
              className="flex border-b group border-white/50 items-center hover:border-white justify-between py-2"
            >
              {page.title}
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      {/* Copyright section */}
      <div className="flex mt-24 flex-col items-center justify-between sm:flex-row">
        <p>
          Copyright © {new Date().getFullYear()} Orglife Industries Pvt. Ltd. |
          All right reserved.
        </p>
      </div>
    </footer>
