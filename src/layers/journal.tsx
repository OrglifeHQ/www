...
const JournalPage: React.FC<{ journal: IJournal }> = ({ journal }) => {
  return (
    <section
      className="bg-cover bg-center max-md:px-4 text-white md:py-24"
      style={{
        backgroundImage:
    ...
    >
      <div className="mx-auto flex gap-8 max-md:flex-col md:max-w-7/8 md:flex-row-reverse">
        {/* Left section */}
        <div className="flex-1 space-y-4">
          <h1 className="text-2xl leading-tight font-medium md:text-[3rem]">
            {journal?.title}
          </h1>
