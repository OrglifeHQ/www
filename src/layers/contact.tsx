...
const Contact: React.FC = () => {
    return (
        <>
            <section
                className="flex flex-col items-center bg-cover bg-center py-24 max-md:px-4"
                style={{
            ...
            >
                ...
                <div className="mt-16 flex w-full gap-8 max-md:flex-col md:max-w-7/8">
                    {/* Left Side */}
                    <div className="hidden w-full flex-col justify-between gap-8 md:flex">
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="mb-8 flex flex-col gap-4">
                                ...
                                <p>
                                    {siteConfig.company.addressOne}
                                    <br />
                                    {siteConfig.company.addressTwo}
                                </p>
                            </div>
                            ...
                            {/* <span className="mt-1 block h-0.5 w-24 bg-white/75"></span> */}
                        </div>
